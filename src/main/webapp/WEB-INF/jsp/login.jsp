	  ...
	  <div class="col-md-offset-3 col-md-6 col-sm-12">
		 ...
		 <form class="form-horizontal" action="" method="post">
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" id="title" name="uname" placeholder="请输入用户名">
			</div>
		  </div>
		  <div class="form-group">
			<label for="title" class="col-sm-2 control-label">密码</label>
			<div class="col-sm-10">
			  <input type="password" class="form-control" id="title" name="upwd" placeholder="请输入密码">
			</div>
		  </div>
		  ...
		  <b>没有账户？您可以点击此处进行<a href="/weibo/reg">注册</a></b>
		</form>
